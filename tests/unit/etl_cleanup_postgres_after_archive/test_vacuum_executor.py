...
@patch("src.etl_cleanup_postgres_after_archive.vacuum_executor.get_postgres_connection")
...
@patch("src.etl_cleanup_postgres_after_archive.vacuum_executor.get_postgres_connection", side_effect=Exception("Vacuum failed"))
